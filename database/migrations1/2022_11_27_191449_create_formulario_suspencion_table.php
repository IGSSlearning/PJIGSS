...
class CreateFormularioSuspencionTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('formulario_suspencion', function (Blueprint $table) {
            $table->integer('id_formulario_suspencion')->primary();
            ...
            $table->foreign('id_suspension', 'fk_formulario_suspencion_suspension1')->references('id_suspension')->on('suspension')->onDelete('set NULL')->onUpdate('restrict');
        });
    }
